...
def get_EXP_RM_Boosts(data):
    ...
    names_fixed = {
        '10000200': 'Tyro',
        '10400100': 'Cecil (Dark Knight)',
        '10400200': 'Cecil (Paladin)',
        '10401500': 'Cid (IV)',
        '10701100': 'Cid (VII)',
        '11400800': 'Cid (XIV)',
        '10500600': 'Gogo (V)',
    ...
    for buddy in buddies:
        ...
        if exp_boost!=0:
            ...
            name = str(names_fixed[buddy_id]) if (buddy_id in names_fixed) else str(buddy['params'][0]['disp_name']) # Use the alternative name from the 'names_fixed' array if it was defined. Otherwise use the default name.
