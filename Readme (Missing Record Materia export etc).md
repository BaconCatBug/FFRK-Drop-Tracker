...
If you wish to remove shared Soul Breaks from the Soul Break export, edit line 221 to look for "categoryId >= 3" instead of 2. Alternatively if you want to export all your characters default soul break for some reason, change it to 1.
